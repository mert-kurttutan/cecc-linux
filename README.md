...
```sh
wget https://github.com/mert-kurttutan/cecc-linux/releases/download/v0.1.25/excalibur-control-center_0.1.25_amd64.deb
sudo apt install ./excalibur-control-center_0.1.25_amd64.deb
```
...
```sh
wget https://github.com/mert-kurttutan/cecc-linux/releases/download/v0.1.25/excalibur-control-center-0.1.25-1.x86_64.rpm
sudo dnf install ./excalibur-control-center-0.1.25-1.x86_64.rpm
```
