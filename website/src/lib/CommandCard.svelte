...
<article class={className}>
  ...
  <div class="relative">
    <button
      ...
      type="button"
      aria-label={copyState === 'copied' ? copiedAriaLabel : copyState === 'failed' ? failedAriaLabel : copyAriaLabel}
      title={copyState === 'copied' ? copiedLabel : copyState === 'failed' ? failedAriaLabel : copyLabel}
      onclick={copyCommand}
    >
